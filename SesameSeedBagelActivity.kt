...
class SesameSeedBagelActivity : AppCompatActivity() {
    private lateinit var quantityInput: EditText

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sesame_seed_bagel)
        ...
        addToCartButton.setOnClickListener {
            val itemName = "Sesame Seed Bagel" // You can get the item name dynamically
