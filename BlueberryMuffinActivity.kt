...
class BlueberryMuffinActivity : AppCompatActivity() {
    private lateinit var quantityInput: EditText

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_blueberry_muffin)
        ...
        addToCartButton.setOnClickListener {
            val itemName = "Blueberry Muffin" // You can get the item name dynamically
