...
class ChocolateChipMuffinActivity : AppCompatActivity() {
    private lateinit var quantityInput: EditText

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chocolate_chip_muffin)
        ...
        addToCartButton.setOnClickListener {
            val itemName = "Chocolate Chip Muffin" // You can get the item name dynamically
